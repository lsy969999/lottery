...
export function Machine(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('models/ballcase2.glb') as GLTFResult
  ...
  const resultHelperRef = useRef<RapierRigidBody>(null);
      ...
      <group >
        ...
        >
            <BallCollider
                ...
                //     console.log('onIntersectionEnter', payload.other)
                //     // console.log("Goal!", payload)
                    
                //     // payload.target.rigidBody?.applyImpulse({ x: 0, y: 0, z: 0 }, true)
                //     // payload.other.rigidBody?.applyImpulse({ x: 0, y: 0, z: -1 }, true)
                //     // payload.other.rigidBody?.applyImpulse({ x: 0, y: 0, z: -0.011 }, true)
                //     // upperCapRef.current?.setTranslation({x: 0, y: 0, z: 0}, true)
                // }}
            />
        </RigidBody> */}
